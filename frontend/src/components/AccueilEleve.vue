<template>
  <v-container>
    <v-row>
      <v-col name="character-container" class="d-flex justify-center" cols="6" md="5">
        <v-card class="d-flex justify-center" width="100%" height="95%" outlined flat>
          <img
            class="earth justify-center"
            src="https://images.fineartamerica.com/images/artworkimages/medium/1/pixel-earth-design-martin-capek-transparent.png"
          />
          <div class="character-container justify-center">
            ...
            <div
              ...
              class="character character-facialHair"
              id="character-facialHair"
            ></div>
            ...
            <div>
              <v-card outlined tile>
                ...
                <v-row style="position: relative; left: 2.5%;">
                  ...
                  <br />
                </v-row>Point de compétence disponible: 0
                <br />
                <inventory></inventory>
              </v-card>
            </div>
...
export default {
  ...
  methods: {
    skinPerso: async function() {
      ...
      document.getElementById("character-hair").style.backgroundImage =
        "url(" +
        this.image(
          "./SpriteCharacter/hair/" +
            perso.hairStyle +
            "/" +
            perso.hairColor +
            ".png"
        ...
        ")";
      document.getElementById("character-ears").style.backgroundImage =
        "url(" +
        this.image("./SpriteCharacter/ears/" + perso.ears + ".png") +
        ")";
      document.getElementById("character-eyes").style.backgroundImage =
        "url(" +
        this.image("./SpriteCharacter/eyes/" + perso.eyes + ".png") +
        ")";
      document.getElementById("character-nose").style.backgroundImage =
        "url(" +
        this.image("./SpriteCharacter/nose/" + perso.nose + ".png") +
        ")";
      document.getElementById("character-facialHair").style.backgroundImage =
        "url(" +
        this.image(
          "./SpriteCharacter/facialHair/" +
            perso.facialHairStyle +
            "/" +
            perso.facialHairColor +
            ".png"
        ) +
        ")";
      document.getElementById("character-facialHair").style.backgroundImage =
        ...
        ")";
      if (perso.genre === "male") {
        document.getElementById("character-pants").style.backgroundImage =
          "url(" +
          this.image("./SpriteCharacter/male/pants/" + perso.pants + ".png") +
          ")";
        document.getElementById("character-shirt").style.backgroundImage =
          "url(" +
          this.image("./SpriteCharacter/male/shirt/" + perso.shirt + ".png") +
          ")";
        document.getElementById("character-shoes").style.backgroundImage =
          "url(" +
          this.image("./SpriteCharacter/male/shoes/" + perso.shoes + ".png") +
          ")";
        document.getElementById("character-weapon").style.backgroundImage =
          "url(" +
          this.image("./SpriteCharacter/male/weapon/" + perso.weapon + ".png") +
          ")";
        document.getElementById("character-body").style.backgroundImage =
          "url(" +
          this.image("./SpriteCharacter/male/body/" + perso.race + ".png") +
          ")";
      } else {
        document.getElementById("character-pants").style.backgroundImage =
          "url(" +
          this.image("./SpriteCharacter/female/pants/" + perso.pants + ".png") +
          ")";
        document.getElementById("character-shirt").style.backgroundImage =
          "url(" +
          this.image("./SpriteCharacter/female/shirt/" + perso.shirt + ".png") +
          ")";
        document.getElementById("character-shoes").style.backgroundImage =
          "url(" +
          this.image("./SpriteCharacter/female/shoes/" + perso.shoes + ".png") +
          ")";
        document.getElementById("character-weapon").style.backgroundImage =
          "url(" +
          this.image(
            "./SpriteCharacter/female/weapon/" + perso.weapon + ".png"
          ) +
          ")";
        document.getElementById("character-body").style.backgroundImage =
          "url(" +
          this.image("./SpriteCharacter/female/body/" + perso.race + ".png") +
          ")";
      }
  ...
  created() {
    ...
    setInterval(() => {
      ...
      if (this.currentCharacterSpriteX === 0)
        this.currentCharacterSpriteY = (this.currentCharacterSpriteY + 1) % 12;
